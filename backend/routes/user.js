...
const { bookTour, getBookings, getUserBooking, getBooking, confirmBooking, addFavourites, getFavourites, deleteFavourites, getEachFavourites } = require("../controllers/userInteractionController");
